...
def load_init_table():
	...
	#load table
	input_tab=np.loadtxt('init.dat', dtype='U', comments='#')
...
def load_molecules_table():
	...
	#load table
	mol_tab=np.loadtxt('molecules.dat', dtype='U', comments='%')
...
<ExpFiles>
 ...
 <file>
     ...
     <IsoTableFileName>""" + str(working_directory) + """isotopologues_""" + str(cores[j]) + """.dat</IsoTableFileName>
</ExpFiles>"""
			)
			file.close() 
